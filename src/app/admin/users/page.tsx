...
import { Loader2, Search, Mail, ShieldCheck } from "lucide-react"
      ...
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative">
            ...
            <Input placeholder="Search by name or email..." className="pl-9 w-[300px]" />
          </div>
        </div>
                    ...
                    <TableRow key={user.id}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <div className="size-8 rounded-full bg-slate-100 flex items-center justify-center font-bold">
                            {user.name.charAt(0)}
                          </div>
                          <div>
                      ...
                      <TableCell>
                        <Badge variant={user.role === 'super-admin' ? 'default' : 'secondary'}>
                          <div className="flex items-center gap-1">
                            {user.role === 'super-admin' && <ShieldCheck className="size-3" />}
                            {user.role}
                          </div>
                        </Badge>
                      </TableCell>
