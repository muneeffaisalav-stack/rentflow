...
import { Building2, MapPin, Plus, MoreVertical, Users, Loader2 } from "lucide-react"
...
export default function PropertiesPage() {
  ...
  const handleAddProperty = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const propertyData = {
      propertyName: formData.get("name") as string,
        ...
        {loading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {properties.map((property, index) => {
              const tenantCount = allTenants.filter(t => t.propertyId === property.id).length
